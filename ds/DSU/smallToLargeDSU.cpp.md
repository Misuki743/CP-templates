...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"ds/DSU/smallToLargeDSU.cpp\"\n//note: op(b1, b2) b1 -> b2\n\
  ...
  verifiedWith: []
documentation_of: ds/DSU/smallToLargeDSU.cpp
layout: document
redirect_from:
- /library/ds/DSU/smallToLargeDSU.cpp
- /library/ds/DSU/smallToLargeDSU.cpp.html

...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"graph/weighted_tree_diameter.cpp\"\ntemplate<class T>\n\
    tuple<T, T, T, vector<int>> weighted_tree_diameter(vector<vector<pair<int, T>>>\
...
documentation_of: graph/weighted_tree_diameter.cpp
layout: document
redirect_from:
- /library/graph/weighted_tree_diameter.cpp
- /library/graph/weighted_tree_diameter.cpp.html

...
data:
  ...
  - name: ds/DSU
    ...
    - icon: ':warning:'
      path: ds/DSU/bipartiteDSU.cpp
      title: ds/DSU/bipartiteDSU.cpp
    - icon: ':warning:'
      path: ds/DSU/monoidDSU.cpp
      title: ds/DSU/monoidDSU.cpp
    - icon: ':warning:'
    ...
    - icon: ':warning:'
      path: ds/DSU/smallToLargeDSU.cpp
      title: ds/DSU/smallToLargeDSU.cpp
  - name: ds
    pages:
    - icon: ':x:'
      path: ds/RMQ.cpp
...
the "KACTL" in the reference of template code is from https://github.com/kth-competitive-programming/kactl
